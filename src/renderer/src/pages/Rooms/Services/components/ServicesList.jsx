...
export default function ServicesList({ data, columns, setRoomServices }) {
            ...
            <TableBody>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  ...
                  >
                    <EmptyComponent
                      title="No Room Services Found!"
                      description="Add new service to get started."
                      modalButtonText="New Service"
                      setIsModalOpen={setIsModalOpen}
                    />
                    {/*  */}
                  </TableCell>
