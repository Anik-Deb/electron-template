...
export default function AmenitiesList({ data, columns, setAmenities }) {
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center border border-border rounded-md h-8 px-2">
                  <>
                    ...
                    <Input
                      placeholder="Find by amenity name..."
                      onChange={(event) =>
                        table
                          .getColumn('amenity_name')
                ...
                <TableRow>
                  ...
                  >
                    <EmptyComponent
                      ...
                      description="Add new amentity to get started."
                      modalButtonText="New Amenity"
                      setIsModalOpen={setIsModalOpen}
                    />
                  </TableCell>
                </TableRow>
