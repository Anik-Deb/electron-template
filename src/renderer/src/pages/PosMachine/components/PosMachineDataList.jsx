...
import AddPosMachine from '../AddPosMachine';

export default function PosMachineDataList({ data, columns, setPosMachines }) {
    ...
    <>
      <div className="w-full">
        <div className="flex justify-between items-end">
          <PageTitle title="All Pos Machines" />
          <div className="flex items-center gap-4">
            {/* Add User modal */}
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              <ModalTrigger>
                <Plus className="w-4 h-4" /> New Pos Machine
              </ModalTrigger>
              {/* add  form */}
              <AddPosMachine
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center border border-border rounded-md h-8 px-2">
                  <>
                    ...
                    <Input
                      placeholder="Find by machine name..."
                      onChange={(event) =>
                        table
                          .getColumn('name')
            ...
            <TableBody>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  ...
                  >
                    <EmptyComponent
                      title="No Pos Machines Found!"
                      description="Add new Pos Machine to get started."
                      modalButtonText="New Pos Machine"
                      setIsModalOpen={setIsModalOpen}
                    />
                  </TableCell>
                </TableRow>
