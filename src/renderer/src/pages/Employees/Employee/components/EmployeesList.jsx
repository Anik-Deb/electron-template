...
const EmployeesList = ({ data, columns }) => {
      ...
      <div className="w-full">
        <div className={`flex justify-between items-end`}>
          ...
          <div className="flex items-center gap-4">
            {/* Add Receptionists */}
            <div>
              <Link to="/employees/employee/add-employee">
                ...
                <TableRow>
                  ...
                  >
                    <EmptyComponent
                      ...
                      description="Add new employee to get started."
                      ctaText="New Employee"
                      ctaUrl="/employees/employee/add-employee"
                    />
                  </TableCell>
                </TableRow>
              )}
