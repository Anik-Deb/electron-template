...
export default function StoreRoomList({ data, columns, setStoreRoomData }) {
        ...
        <div className="flex justify-between items-end">
          ...
          <div className="flex items-center gap-4">
            ...
            <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
              ...
              {/* add form */}
              {/* <AddEquipment
                      setStoreRoomData={setStoreRoomData}
            ...
            <TableBody>
              {table.getRowModel().rows?.length ? (
                ...
                <TableRow>
                  ...
                  >
                    <EmptyComponent
                      title="No Room List Items Found!"
                      description="Add Room List Item to get started."
